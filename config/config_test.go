...
func TestYAMLRoundtrip(t *testing.T) {
	want, err := LoadFile("testdata/roundtrip.good.yml", ServerMode, false, log.NewNopLogger())
...
func TestRemoteWriteRetryOnRateLimit(t *testing.T) {
	want, err := LoadFile("testdata/remote_write_retry_on_rate_limit.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
...
func TestOTLPSanitizeResourceAttributes(t *testing.T) {
	t.Run("good config", func(t *testing.T) {
		want, err := LoadFile(filepath.Join("testdata", "otlp_sanitize_resource_attributes.good.yml"), ServerMode, false, log.NewNopLogger())
		require.NoError(t, err)
	...
	t.Run("bad config", func(t *testing.T) {
		_, err := LoadFile(filepath.Join("testdata", "otlp_sanitize_resource_attributes.bad.yml"), ServerMode, false, log.NewNopLogger())
...
func TestLoadConfig(t *testing.T) {
	...
	_, err := LoadFile("testdata/global_timeout.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)

	c, err := LoadFile("testdata/conf.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
	require.Equal(t, expectedConf, c)
}

func TestScrapeIntervalLarger(t *testing.T) {
	c, err := LoadFile("testdata/scrape_interval_larger.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
...
func TestLoadConfigRuleFilesAbsolutePath(t *testing.T) {
	...
	c, err := LoadFile(ruleFilesConfigFile, ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
	require.Equal(t, ruleFilesExpectedConf, c)
}

func TestKubernetesEmptyAPIServer(t *testing.T) {
	_, err := LoadFile("testdata/kubernetes_empty_apiserver.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
}

func TestKubernetesWithKubeConfig(t *testing.T) {
	_, err := LoadFile("testdata/kubernetes_kubeconfig_without_apiserver.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
}

func TestKubernetesSelectors(t *testing.T) {
	_, err := LoadFile("testdata/kubernetes_selectors_endpoints.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
	_, err = LoadFile("testdata/kubernetes_selectors_node.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
	_, err = LoadFile("testdata/kubernetes_selectors_ingress.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
	_, err = LoadFile("testdata/kubernetes_selectors_pod.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
	_, err = LoadFile("testdata/kubernetes_selectors_service.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
}
...
func TestBadConfigs(t *testing.T) {
	for _, ee := range expectedErrors {
		_, err := LoadFile("testdata/"+ee.filename, ServerMode, false, log.NewNopLogger())
...
func TestExpandExternalLabels(t *testing.T) {
	...
	c, err := LoadFile("testdata/external_labels.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
	...
	c, err = LoadFile("testdata/external_labels.good.yml", ServerMode, true, log.NewNopLogger())
	require.NoError(t, err)
...
func TestAgentMode(t *testing.T) {
	_, err := LoadFile("testdata/agent_mode.with_alert_manager.yml", AgentMode, false, log.NewNopLogger())
	require.ErrorContains(t, err, "field alerting is not allowed in agent mode")

	_, err = LoadFile("testdata/agent_mode.with_alert_relabels.yml", AgentMode, false, log.NewNopLogger())
	require.ErrorContains(t, err, "field alerting is not allowed in agent mode")

	_, err = LoadFile("testdata/agent_mode.with_rule_files.yml", AgentMode, false, log.NewNopLogger())
	require.ErrorContains(t, err, "field rule_files is not allowed in agent mode")

	_, err = LoadFile("testdata/agent_mode.with_remote_reads.yml", AgentMode, false, log.NewNopLogger())
	require.ErrorContains(t, err, "field remote_read is not allowed in agent mode")

	c, err := LoadFile("testdata/agent_mode.without_remote_writes.yml", AgentMode, false, log.NewNopLogger())
	require.NoError(t, err)
	require.Empty(t, c.RemoteWriteConfigs)

	c, err = LoadFile("testdata/agent_mode.good.yml", AgentMode, false, log.NewNopLogger())
	require.NoError(t, err)
...
func TestGetScrapeConfigs(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			c, err := LoadFile(tc.configFile, ServerMode, false, log.NewNopLogger())
			require.NoError(t, err)
...
func TestScrapeConfigDisableCompression(t *testing.T) {
	want, err := LoadFile("testdata/scrape_config_disable_compression.good.yml", ServerMode, false, log.NewNopLogger())
	require.NoError(t, err)
...
func TestScrapeConfigNameValidationSettings(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			want, err := LoadFile(fmt.Sprintf("testdata/%s.yml", tc.inputFile), ServerMode, false, log.NewNopLogger())
			require.NoError(t, err)
